        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cardOwnerName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    cardNumber = table.Column<string>(type: "varchar(25)", maxLength: 25, nullable: true),
                    expirationDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    securityCode = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
